...
abstract class SharedPreferenceImpl<T> {
    ...
    static class Bool extends SharedPreferenceImpl<Boolean> {
        @Override
    ...
    static class Int extends SharedPreferenceImpl<Integer> {
        @Override
    ...
    static class LongInt extends SharedPreferenceImpl<Long> {
        @Override
    ...
    static class Floating extends SharedPreferenceImpl<Float> {
        @Override
    ...
    static class Text extends SharedPreferenceImpl<String> {
        @Override
