 ...
 * @since Apr 4, 2011
 */
public class AutoResizeButton extends android.support.v7.widget.AppCompatButton {
    ...
    // Text size that is set find code. This acts as a starting point for resizing
